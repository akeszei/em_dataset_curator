...
if __name__ == "__main__":
    ...
    # find_star_column_index_from_table(star_file, 'data_', '_filamentDiameterPixels', VERBOSE=True)
    get_column_values_from_table(star_file,'data_','_filamentDiameterPixels', VERBOSE = True)
